...
import AlumniDashboard from '@/components/stats/dashboard'

export default function Home() {
  return (
    <div className="relative w-full min-h-screen bg-ugm-bg-light">
      {/* Hero Section */}
      <div className="w-full flex justify-center items-center py-20 px-4">
        <div className="flex flex-col justify-center gap-6 items-center z-10 max-w-4xl mx-auto">
          {/* Main Heading */}
