  ...
  return (
    <div className="min-h-screen py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4">
          ...
          {!isAuthenticated && (
            <div className="mt-4 p-4 bg-yellow-900/30 border border-yellow-700 rounded-lg text-center">
              <p className="text-sm text-yellow-300">
                <strong>Info:</strong> Anda melihat data terbatas.{' '}
                <Link href="/admin" className="text-blue-400 hover:underline font-medium">
                  Login sebagai admin
                </Link>{' '}
                untuk melihat detail lengkap dan menggunakan filter lengkap.
              </p>
            </div>
          )}
        </div>
        ...
        {!isAuthenticated && (
          <div className="mb-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-center border border-blue-500 shadow-xl">
              ...
              {!isAuthenticated ? (
                <div className="text-center py-8">
                  {person.photo?.url ? (
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center border-2 border-gray-700 mx-auto mb-4">
                  ...
                  <p className="text-blue-400 font-medium">Angkatan {person.batch}</p>
                  <div className="mt-4 pt-4 border-t border-gray-700">
                    <p className="text-sm text-gray-400">Login untuk melihat detail lengkap</p>
                  </div>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex items-start space-x-4 mb-4">
                    ...
                    {person.photo?.url ? (
                      ...
                      <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center border-2 border-gray-700">
                        <span className="text-white text-2xl font-bold">
                          {person.name.charAt(0).toUpperCase()}
                        </span>
                      </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-xl font-semibold truncate text-white">{person.name}</h3>
                      <p className="text-blue-400 font-medium">Angkatan {person.batch}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-700 rounded-lg p-3">
                      <p className="text-sm font-medium truncate text-white">{person.position}</p>
                      <p className="text-sm text-gray-400 truncate">@ {person.currentEmployer}</p>
                    </div>
                    ...
                    {person.workField && person.workField.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {person.workField.slice(0, 2).map((field, index) => (
                          <span
                            key={index}
                            className="px-2 py-1 text-xs bg-blue-900/50 text-blue-300 rounded-full border border-blue-700"
                          >
                    ...
                    <div className="flex items-center space-x-3 pt-2 border-t border-gray-700">
                      ...
                      <div className="flex space-x-1 ml-auto">
                        {person.contactPersonReady && (
                          <span
                            className="px-2 py-1 text-xs bg-green-900/50 text-green-300 rounded-full border border-green-700"
                        ...
                        {person.alumniOfficerReady && (
                          <span
                            className="px-2 py-1 text-xs bg-purple-900/50 text-purple-300 rounded-full border border-purple-700"
                    ...
                    {person.willingToHelp && person.willingToHelp.length > 0 && (
                      <div className="pt-2 border-t border-gray-700">
                        <p className="text-xs text-gray-400 mb-1">Bersedia membantu:</p>
                        <div className="flex flex-wrap gap-1">
                          {person.willingToHelp.slice(0, 2).map((help, index) => (
                            <span
                              key={index}
                              className="px-2 py-1 text-xs bg-yellow-900/50 text-yellow-300 rounded-full border border-yellow-700"
                            >
        ...
        {filteredAlumni.length === 0 && initialized && (
          <div className="text-center py-12">
            <div className="w-24 h-24 mx-auto mb-4 bg-gray-800 rounded-full flex items-center justify-center border-2 border-gray-700">
              <svg
            ...
            <p className="text-gray-400">
              {isAuthenticated
                ...
                : searchName || filterBatch
                  ...
                  : 'Login untuk melihat lebih banyak data'}
            </p>
